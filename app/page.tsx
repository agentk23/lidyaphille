  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-zinc-50 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none">
        <div className="relative w-[90vw] h-[30vh] sm:w-[90vw] sm:h-[30vh] shadow-2xl rounded-3xl">
          <Image
            src="/2ndbg.jpg"
            alt="Page Background"
            fill
      ...
      <main className="relative flex max-h-screen w-full max-w-3xl flex-col items-center justify-center py-16 px-4 sm:py-32 sm:px-16  sm:items-start">
        ...
        <ImageMenuContainer className="min-h-[50vh] xl:min-h-[80vh] lg:min-h-[70vh] sm:max-h-[50vh] md:min-h-[60vh]  max-w-[60vw] sm:max-w-[55vw] md:max-w-[55vw] lg:max-w-[50vw] xl:min-w-[30vw]">
          <InteractiveNav />
        </ImageMenuContainer>

...
export const InteractiveNav = () => {
  ...
  return (
    <nav className="flex flex-col md:gap-20 gap-10 p-10 relative w-fit top-15 ">
      {SECTIONS.map((section, index) => (
        ...
        >
          {/* The Text Section */}
          <span
            className={` text-3xl md:text-5xl transition-shadow  ${
              activeIndex === index ? "text-black font-stretch-50% " : "text-black rotate-2 shadow-2xs"
            }`}
          >
            <Link
          ...
          {activeIndex === index && (
            <motion.div
              ...
              className="absolute top-1/2 -left-10 md:-left-12 -translate-y-1/2 pointer-events-none"
              transition={{
                type: "spring",
                stiffness: 250,
                damping: 25,

  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-zinc-50 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none">
        <div className="relative w-[90vw] h-[40vh] sm:w-[90vw] sm:h-[40vh] shadow-2xl rounded-3xl">
          <Image
            src="/2ndbg.jpg"
            alt="Page Background"
            fill
      ...
      <main className="relative z-10 flex min-h-screen w-full max-w-3xl flex-col items-center justify-center py-16 px-4 sm:py-32 sm:px-16 sm:items-start">
        <div className="relative w-full h-[8vh] text-black text-center text-xl sm:text-4xl blur-xs opacity-90 top-13 sm:top-10">
        ...
        <div className="relative w-full h-[8vh] rotate-y-180 rotate-x-180  text-black text-center text-xl md:text-4xl blur-xs opacity-90  bottom-15 sm:text-4xl  ">
          <h1>Luiza Pomohaci</h1>
        </div>
      </main>
    </div>
